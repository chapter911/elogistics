...
$(function () {
  // Modal id
  const appModal2 = document.getElementById('createApp2');
  ...
  appModal2.addEventListener('show.bs.modal', function (event) {
    const wizardCreateApp = document.querySelector('#wizard-create-app2');
