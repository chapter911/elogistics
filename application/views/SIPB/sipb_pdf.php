...
$slip = "";
$reservasi_text = "Reservasi";
$reservasi = "";

if($header[0]->form_name == "reservasi"){
    $slip = $header[0]->slip;
    $reservasi = $header[0]->reservasi;
} else if($header[0]->form_name == "antar_unit"){
    $slip = $header[0]->no_tug8;
    $reservasi_text = "TUG 5 / PR";
    $reservasi = $header[0]->no_tug5 ?? "-";
} else {
    $slip = $header[0]->slip ?? "-";
    $reservasi = $header[0]->reservasi ?? "-";
}
