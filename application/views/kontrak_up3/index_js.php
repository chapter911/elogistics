<script>
    ...
    function getMaterialKontrak($id) {
        $url = "<?= base_url() ?>C_Kontrak/getMaterialKontrakUP3?id=" + $id;
        $.ajax({
            url: $url,
            type: "GET",
            data: "text",
    ...
    function getDetailNilai($id) {
        $url = "<?= base_url() ?>C_Kontrak/getDetailNilaiUP3?id=" + $id;
        $.ajax({
            url: $url,
            type: "GET",
            data: "text",
    ...
    function delete_data($id, $produk) {
        $url = "<?= base_url() ?>C_Kontrak/delete_data_up3?id=" + $id;
        Swal.fire({
    ...
    function editdata($id) {
        $url = "<?= base_url() ?>C_Kontrak/get_data_editUP3";
        $.ajax({
            url: $url,
            type: "POST",
            data: {
