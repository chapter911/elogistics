<div class="table-responsive">
    <table id="kt_datatable_fixed_header" class="table align-middle table-bordered table-hover table-row-bordered" style="white-space: nowrap;">
        <thead>
            <tr style="background-color: #008B8B">
                ...
                <th style="text-align: center; vertical-align: middle; color: white;"> RASIO </th>
        ...
        <tbody>
            <?php $i =1; foreach ($data as $d) { ?>
                <tr>
                    ...
                    <td>
                        <input type="number" name="volume[]" class="form-control mb-3 mb-lg-0" value="<?= html_escape($d->volume); ?>"/>
                    </td>
                    <td style="text-align: right">
                        <input type="number" name="approved_volume[]" min="<?= html_escape($d->approved_volume); ?>" max="<?= html_escape($d->volume); ?>" class="form-control mb-3 mb-lg-0" value="<?= html_escape($d->approved_volume); ?>" required/>
                    </td>
