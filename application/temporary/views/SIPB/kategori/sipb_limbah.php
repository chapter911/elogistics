...
<form class="form" action="<?= base_url(); ?>C_SIPB/Save" method="POST" enctype="multipart/form-data">
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-4">
            ...
            <input type="text" name="plat_no" id="plat_no_limbah"
    ...
    <div class="row mb-4">
        <div class="col-md-4">
            ...
            <input type="hidden" name="unit_asal" id="unit_asal_limbah"
        ...
        <div class="col-md-4">
            <div id="select2_limbah_container">
                <label class="required fw-semibold fs-6 mb-2">Unit Tujuan</label>
                <select name="unit_tujuan" id="<?= isset($header) ? "unit_tujuan_limbah_update" : "unit_tujuan_limbah"; ?>" class="select2"
            ...
            <div id="manual_limbah_container" style="display: none;">
                ...
                <input type="text" name="unit_tujuan_manual" id="unit_tujuan_manual_limbah"
                    value="<?= isset($header) ? '$header[0]->unit_tujuan_manual' : '' ; ?>"
                    class="form-control mb-3 mb-lg-0" placeholder="Tujuan" />
            </div>
            <div class="row">
                <input type="checkbox" name="manual_destination"
                    id="<?= isset($header) ? "manual_destination_limbah_update" : "manual_destination_limbah"; ?>"
                    class="form-check-input" onchange="setTujuanLimbah(this)" />
        ...
        <div class="col-md-4">
            ...
            <select name="bidang_tujuan"
                id="<?= isset($header) ? "bidang_tujuan_limbah_update" : "bidang_tujuan_limbah"; ?>"
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-4">
            ...
            <input type="text" name="ttd_pembawa_barang" id="pembawa_barang_limbah"
                class="form-control mb-3 mb-lg-0"
    ...
    <div class="row mb-4">
        ...
        <div class="row mb-4">
            <div class="col-md-6">
                ...
                <input type="file" name="file_surat_usulan_limbah" id="file_surat_usulan_limbah"
                    class="form-control" accept=".pdf" placeholder="Surat AE 1" required />
            </div>
        </div>
    </div>
    <?php } ?>
