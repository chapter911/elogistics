<div class="card card-action mb-12">
    <div class="card-header">
        <h5 class="card-action-title mb-0">Target Realisasi</h5>
    </div>
            ...
            <div class="row">
                <div class="col-3">
                    <div class="fv-row mb-7">
                        ...
                        <select name="periode_realisasi" id="periode_realisasi" class="form-select"  onchange="filterData()" required>
...
<div class="modal fade" id="modal_upload" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form class="form" action="<?= base_url(); ?>C_ITO/upload_target" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>">
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col mb-4">
                            <a href="<?= base_url(); ?>data_uploads/ito/format/target_realisasi.xlsx" download target="_blank"
...
$(document).ready(function() {
    table = $("#table").DataTable({
        ...
        "pageLength": 10,
        "ajax": {
            "url": "<?= base_url() ?>C_ITO/AjaxTargetRealisasi",
            "type": "post",
            "beforeSend": function() {
                Swal.fire({
                    title: 'Mohon Tunggu',
            ...
            "data": function(data) {
                data.periode = $("#periode_realisasi").val(),
